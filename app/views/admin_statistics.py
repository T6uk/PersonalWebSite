...
def event_statistics(event_id):
    ...
    if event.event_type == 'league_game' or event.event_type == 'friendly_match':
        ...
        if match_stats:
            ...
            return render_template('statistics/match_statistics.html',
                                   event=event,
        ...
        if tournament_stats:
            ...
            return render_template('statistics/tournament_statistics.html',
                                   event=event,
...
def add_match_statistics(event_id):
    ...
    return render_template('statistics/add_match_statistics.html',
...
def edit_match_statistics(match_id):
    ...
    return render_template('statistics/edit_match_statistics.html',
...
def add_player_performance(match_id):
    ...
    if form.validate_on_submit():
        ...
        return render_template('statistics/performance_added.html',
                               match_stats=match_stats,
                               event=event)
...
def edit_player_performance(performance_id):
    ...
    return render_template('statistics/edit_player_performance.html',
...
def add_tournament_statistics(event_id):
    ...
    return render_template('statistics/add_tournament_statistics.html',
...
def edit_tournament_statistics(tournament_id):
    ...
    return render_template('statistics/edit_tournament_statistics.html',
...
def add_tournament_match(tournament_id):
    ...
    if form.validate_on_submit():
        ...
        return render_template('statistics/match_added.html',
                               tournament_stats=tournament_stats,
                               event=event)
    ...
    return render_template('statistics/add_tournament_match.html',
...
def edit_tournament_match(match_id):
    ...
    return render_template('statistics/edit_tournament_match.html',
...
def player_statistics(player_id):
    ...
    return render_template('statistics/player_statistics.html',
                           player=player,
